...
> This optional API presentation package exposes approved HTTP operations for the ISP domain module. It presents exactly one independent module, delegates all authoritative behavior to that module's public actions/queries/policies, and contains no other module's API logic.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-isp-api?sort=semver)](https://github.com/liberusoftware/module-billing-isp-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-isp-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-isp-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-isp-api
```
...
<a href="https://github.com/liberusoftware/module-billing-isp-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-isp-api" alt="Contributors to liberusoftware/module-billing-isp-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-isp-api/graphs/contributors).
